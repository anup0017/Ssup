...
public class RequestsFragment extends Fragment {
        ...
        FirebaseRecyclerAdapter<Contacts, RequestsViewHolder> adapter =
                new FirebaseRecyclerAdapter<Contacts, RequestsViewHolder>(options) {
                    ...
                    protected void onBindViewHolder(@NonNull final RequestsViewHolder holder, final int position, @NonNull Contacts model)
                    {
                        ...
                        holder.itemView.findViewById(R.id.decline).setVisibility(View.VISIBLE);
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot)
                            {
                                if (dataSnapshot.exists())
                                {
                                    ...
                                    if (type.equals("received"))
                                    {
                                        UsersRef.child(list_user_id).addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(DataSnapshot dataSnapshot)
                                            {
                                                ...
                                                //When user clicks on accept request
                                                ...
                                                //When users presses cancel request
                                                holder.itemView.findViewById(R.id.decline).setOnClickListener(new View.OnClickListener() {
                                                    @Override
                                                    public void onClick(View v) {
                                                        ChatRequestsRef.child(currentUserID).child(list_user_id)
                                                                .removeValue()
                                    ...
                                    else if (type.equals("sent"))
                                    {
                                        ...
                                        holder.itemView.findViewById(R.id.decline).setVisibility(View.INVISIBLE);
                                        ...
                                        UsersRef.child(list_user_id).addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(DataSnapshot dataSnapshot)
                                            {
                                                ...
                                                //When user presses the request sent button to cancel the request
                                                holder.itemView.findViewById(R.id.accept).setOnClickListener(new View.OnClickListener() {
                                                    @Override
                                                    public void onClick(View v) {
                                                        ChatRequestsRef.child(currentUserID).child(list_user_id)
    ...
    public static class RequestsViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public RequestsViewHolder(@NonNull View itemView)
        {
            ...
            CancelButton = itemView.findViewById(R.id.decline);
        }
    }
